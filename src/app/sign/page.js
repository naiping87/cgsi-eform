  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('/api/generate-pdf', {
        ...
        body: JSON.stringify({ templateId: data.t, pdfId: data.pdfId, pdfBase64: data.b, formData: data.f || {}, signatures: processed, positions: data.p || {}, overrides: data.o || {}, sigOffsets: data.s || [] }),
      });
      if (res.ok) {
